...
function Header() {
    ...
    const [isSearchActive, setIsSearcgActive] = useState(false);

    const toggleSearchBar = () => {
        setIsSearcgActive(!isSearchActive);
    };
    ...
    <header >
      <div className='header'>
        <div className='header__left'>
            <div className='header__left--logoBox'>
            <a href="#">
            ...
            <div className='header__right--icons'>
                <button className='btn btn--search' onClick={toggleSearchBar}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path fill='#fff' d="M19.023 16.977a35.13 35.13 0 0 1-1.367-1.384c-.372-.378-.596-.653-.596-.653l-2.8-1.337A6.962 6.962 0 0 0 16 9c0-3.859-3.14-7-7-7S2 5.141 2 9s3.14 7 7 7c1.763 0 3.37-.66 4.603-1.739l1.337 2.8s.275.224.653.596c.387.363.896.854 1.384 1.367l1.358 1.392.604.646 2.121-2.121-.646-.604c-.379-.372-.885-.866-1.391-1.36zM9 14c-2.757 0-5-2.243-5-5s2.243-5 5-5 5 2.243 5 5-2.243 5-5 5z"></path>
                    </svg>
                </button>
            
                <button className='btn btn--menu'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" >
                        <path fill='#fff' d="M4 6h16v2H4zm0 5h16v2H4zm0 5h16v2H4z"></path>
                    </svg>
                </button>
            </div>

            <div className='header__right--buttons'>
              <button className='desktop--btn btn--submit'>Submit a request</button>
              <button className='desktop--btn btn--signIn'>Sign in</button>
            </div>
        </div>
      ...
      <div className={`searchBar ${isSearchActive ? 'active' : ''}`}>
        ...
        <button className='btn' onClick={toggleSearchBar}>X</button>
      </div>
